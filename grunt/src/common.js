...
WebConfigUrl.ResourceUrl =$("#ResourceUrl").val();
//抢票接口
WebConfigUrl.GrabTicketOrder = $("#ResourceUrl").val()+"GrabTicketOrder/BookGrabTicketOrder";
//抢票保险接口
WebConfigUrl.robInsurance = $("#ResourceUrl").val() + "Insurance/GetInsurances";

//新保险接口  ---正常流程
WebConfigUrl.newInsurance = $("#ResourceUrl").val() + "Insurance/GetInsurancesWieless";
//轮询下单接口
WebConfigUrl.GetConsumeResult= $("#GetServUrl").val()+"resource/BookOrderConsumerMessage/ConsumeResult";
//新车次查询接口
WebConfigUrl.ticketSearch = $("#GetServUrl").val()+"search/ticket/Search";
//订单详情
...
WebConfigUrl.trainDetailUrl =  $("#SearchUrl").val() + "ticket/searchfortouch";
...
//代金券
WebConfigUrl.UseList = $("#ResourceUrl").val() + "ManageWXCard/GetUserCardListForQQ";
...
//热门城市不可退，数据插入后台
//无意义接口先注释 WebConfigUrl.insertRefund = $("#ResourceUrl").val() + "OrderOperation/UpdatePassengerInfo";
//服务中心
